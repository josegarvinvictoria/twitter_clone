<template>
    <div>
        <div class="text-gray-500 font-medium text-xs flex items-center mb-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" class="fill-current text-gray-500 w-3 mr-2">
            ...
            <span>{{ tweet.user.name }} retwetted</span>
        </div>
        <component
            :is="`app-tweet-type-${tweet.original_tweet.type}`"
